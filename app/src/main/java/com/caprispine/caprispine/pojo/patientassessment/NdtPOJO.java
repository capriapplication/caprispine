...
public class NdtPOJO implements Serializable{
    ...
    @SerializedName("ndtradianleft")
    private String ndtradianleft;
    @SerializedName("ndtradianright")
    private String ndtradianright;
    @SerializedName("ndtmedianleft")
    private String ndtmedianleft;
    @SerializedName("ndtmedianright")
    private String ndtmedianright;
    @SerializedName("ndtmusculocleft")
    private String ndtmusculocleft;
    @SerializedName("ndtmusculocright")
    private String ndtmusculocright;
    ...
    @SerializedName("ndtobturatorleft")
    private String ndtobturatorleft;
    @SerializedName("ndtobturatorright")
    private String ndtobturatorright;
    ...
    @SerializedName("ndtsaphenousright")
    private String ndtsaphenousright;
    @SerializedName("ntpulnarleft")
    private String ntpulnarleft;
    @SerializedName("ntpulnarright")
    private String ntpulnarright;
    @SerializedName("ntpradianleft")
    private String ntpradianleft;
    @SerializedName("ntpradianright")
    private String ntpradianright;
    ...
    @SerializedName("ntpparonialright")
    private String ntpparonialright;
    ...
    public String getNdtradianleft() {
        return ndtradianleft;
    }

    public void setNdtradianleft(String ndtradianleft) {
        this.ndtradianleft = ndtradianleft;
    }

    public String getNdtradianright() {
        return ndtradianright;
    }

    public void setNdtradianright(String ndtradianright) {
        this.ndtradianright = ndtradianright;
    }
    ...
    public String getNdtmedianright() {
        return ndtmedianright;
    }

    public void setNdtmedianright(String ndtmedianright) {
        this.ndtmedianright = ndtmedianright;
    }

    public String getNdtmusculocleft() {
        return ndtmusculocleft;
    }

    public void setNdtmusculocleft(String ndtmusculocleft) {
        this.ndtmusculocleft = ndtmusculocleft;
    }

    public String getNdtmusculocright() {
        return ndtmusculocright;
    }

    public void setNdtmusculocright(String ndtmusculocright) {
        this.ndtmusculocright = ndtmusculocright;
    }
    ...
    public String getNdtobturatorleft() {
        return ndtobturatorleft;
    }

    public void setNdtobturatorleft(String ndtobturatorleft) {
        this.ndtobturatorleft = ndtobturatorleft;
    }

    public String getNdtobturatorright() {
        return ndtobturatorright;
    }

    public void setNdtobturatorright(String ndtobturatorright) {
        this.ndtobturatorright = ndtobturatorright;
    }
    ...
    public String getNdtsaphenousright() {
        return ndtsaphenousright;
    }

    public void setNdtsaphenousright(String ndtsaphenousright) {
        this.ndtsaphenousright = ndtsaphenousright;
    }
    ...
    public String getNtpradianleft() {
        return ntpradianleft;
    }

    public void setNtpradianleft(String ntpradianleft) {
        this.ntpradianleft = ntpradianleft;
    }

    public String getNtpradianright() {
        return ntpradianright;
    }

    public void setNtpradianright(String ntpradianright) {
        this.ntpradianright = ntpradianright;
    }
    ...
    public String getNtpparonialright() {
        return ntpparonialright;
    }

    public void setNtpparonialright(String ntpparonialright) {
        this.ntpparonialright = ntpparonialright;
    }
