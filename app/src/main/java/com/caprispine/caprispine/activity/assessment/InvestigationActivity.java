...
import com.caprispine.caprispine.activity.assessment.add.AddInvestigationActivity;
import com.caprispine.caprispine.activity.assessment.add.AddPainActivity;
import com.caprispine.caprispine.adapter.patientassessment.InvestigationAdapter;
...
public class InvestigationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Investigation Exam");
        ...
        btn_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(InvestigationActivity.this,PhysioTheraputicActivity.class).putExtra("patientPOJO",patientPOJO));
                finish();
            }
        });
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult(new Intent(InvestigationActivity.this, AddInvestigationActivity.class).putExtra("patientPOJO",patientPOJO),Constants.EXAM_START_ACTIVITY_INTENT);
            }
        });
    }
    @Override
    ...
    public void getAllComplaints() {
        ...
        nameValuePairs.add(new BasicNameValuePair("request_action","get_all_investigation"));
        ...
        new WebServiceBase(nameValuePairs, this, new WebServicesCallBack() {
            ...
            public void onGetMsg(String[] msg) {
                ...
                try{
                    ResponseListPOJO<InvestigationPOJO> responseListPOJO = new Gson().fromJson(msg[1], new TypeToken<ResponseListPOJO<InvestigationPOJO>>() {}.getType());
    ...
    public void updateComplaint(PainPOJO painPOJO){
        Intent intent=new Intent(this,AddPainActivity.class);
        intent.putExtra("patientPOJO",patientPOJO);
        intent.putExtra("pain",painPOJO);
    ...
    List<InvestigationPOJO> painPOJOArrayList=new ArrayList<>();

    public void attachAdapter() {
        adapter = new InvestigationAdapter(this,null, painPOJOArrayList);
