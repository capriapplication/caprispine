...
public class AddLumbarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Lumbar Spine");
        ...
        try {
            ...
            new WebUploadService(reqEntity, this, new WebServicesCallBack() {
                ...
                public void onGetMsg(String[] msg) {
                    ...
                    ResponsePOJO<CervicalPOJO> responseListPOJO = new Gson().fromJson(msg[1], new TypeToken<ResponsePOJO<HipExamPOJO>>() {
                    }.getType());
            ...
            }, "CALL_HIP_CRUD_API", true).execute(WebServicesUrls.LUMBAR_CRUD);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
