...
public class AddCervicalSpineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add Cervical Spine");
    ...
    private void saveData(String file_path) {
        try {
            ...
            }, "CALL_HIP_CRUD_API", true).execute(WebServicesUrls.CERVICAL_CRUD);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
