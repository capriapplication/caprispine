...
import com.caprispine.caprispine.activity.assessment.add.AddProgressNoteActivity;
...
public class ProgressNotesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Progress Notes");
        ...
        btn_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ProgressNotesActivity.this,RemarkActivity.class).putExtra("patientPOJO",patientPOJO));
                finish();
            }
        });
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult(new Intent(ProgressNotesActivity.this, AddProgressNoteActivity.class).putExtra("patientPOJO",patientPOJO),Constants.EXAM_START_ACTIVITY_INTENT);
            }
        });
    ...
    public void getAllComplaints() {
        ...
        }, "",false).execute(WebServicesUrls.PROGRESS_NOTE_CRUD);
    }
    ...
    public void attachAdapter() {
        adapter = new DiagnosisAdapter(this,null, painPOJOArrayList,"progress");
