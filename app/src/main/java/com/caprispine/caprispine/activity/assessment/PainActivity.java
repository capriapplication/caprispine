...
import com.caprispine.caprispine.adapter.patientassessment.PainAdapter;
...
public class PainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PainActivity.this,PhysicalActivity.class).putExtra("patientPOJO",patientPOJO));
                finish();
            }
        });
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult(new Intent(PainActivity.this, AddPainActivity.class).putExtra("patientPOJO",patientPOJO),Constants.EXAM_START_ACTIVITY_INTENT);
            }
        });
    }
    ...
    public void getAllComplaints() {
        ...
        new WebServiceBase(nameValuePairs, this, new WebServicesCallBack() {
            ...
            public void onGetMsg(String[] msg) {
                ...
                try{
                    ResponseListPOJO<PainPOJO> responseListPOJO = new Gson().fromJson(msg[1], new TypeToken<ResponseListPOJO<PainPOJO>>() {}.getType());
    ...
    PainAdapter adapter;
    List<PainPOJO> painPOJOArrayList=new ArrayList<>();

    public void attachAdapter() {
        adapter = new PainAdapter(this,null, painPOJOArrayList);
