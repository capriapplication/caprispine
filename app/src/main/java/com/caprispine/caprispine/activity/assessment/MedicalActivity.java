...
import com.caprispine.caprispine.activity.assessment.add.AddMedicalActivity;
...
public class MedicalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Medical Exam");
        ...
        btn_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MedicalActivity.this,TreatmentPlanActivity.class).putExtra("patientPOJO",patientPOJO));
                finish();
            }
        });
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult(new Intent(MedicalActivity.this, AddMedicalActivity.class).putExtra("patientPOJO",patientPOJO),Constants.EXAM_START_ACTIVITY_INTENT);
            }
        });
    }
    ...
    public void getAllComplaints() {
        ...
        }, "",false).execute(WebServicesUrls.MEDICAL_CRUD);
    }
    ...
    public void attachAdapter() {
        adapter = new DiagnosisAdapter(this,null, painPOJOArrayList,"medical");
