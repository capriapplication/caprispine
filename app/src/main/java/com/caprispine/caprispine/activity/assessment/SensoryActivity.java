...
import com.caprispine.caprispine.activity.assessment.add.AddSensoryExamActivity;
import com.caprispine.caprispine.adapter.patientassessment.SensoryAdapter;
...
public class SensoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(SensoryActivity.this,NeuroActivity.class).putExtra("patientPOJO",patientPOJO));
                finish();
            }
        });
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult(new Intent(SensoryActivity.this, AddSensoryExamActivity.class).putExtra("patientPOJO",patientPOJO),Constants.EXAM_START_ACTIVITY_INTENT);
            }
        });
    }
    @Override
    ...
    public void getAllComplaints() {
        ...
        new WebServiceBase(nameValuePairs, this, new WebServicesCallBack() {
            ...
            public void onGetMsg(String[] msg) {
                ...
                try{
                    ResponseListPOJO<SensoryPOJO> responseListPOJO = new Gson().fromJson(msg[1], new TypeToken<ResponseListPOJO<SensoryPOJO>>() {}.getType());
                    complaintList.clear();
        ...
        }, "",false).execute(WebServicesUrls.SENSORY_CRUD);
    }

    public void updateComplaint(SensoryPOJO sensoryPOJO){
        Intent intent=new Intent(this, AddSensoryExamActivity.class);
        intent.putExtra("SensoryPOJO",sensoryPOJO);
    ...
    SensoryAdapter adapter;
    List<SensoryPOJO> complaintList=new ArrayList<>();

    public void attachAdapter() {
        adapter = new SensoryAdapter(this,null, complaintList);
