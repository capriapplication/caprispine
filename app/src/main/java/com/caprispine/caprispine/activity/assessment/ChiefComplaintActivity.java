...
import com.caprispine.caprispine.activity.assessment.add.AddChiefComplaintActivity;
import com.caprispine.caprispine.adapter.patientassessment.ChiefComplaintAdapter;
...
public class ChiefComplaintActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ChiefComplaintActivity.this,HistoryActivity.class).putExtra("patientPOJO",patientPOJO));
                finish();
            }
        });
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(ChiefComplaintActivity.this,AddChiefComplaintActivity.class);
                intent.putExtra("patientPOJO",patientPOJO);
                startActivityForResult(intent, Constants.EXAM_START_ACTIVITY_INTENT);
            }
        });
    }
    ...
    public void getAllComplaints() {
        ...
        new WebServiceBase(nameValuePairs, this, new WebServicesCallBack() {
            ...
            public void onGetMsg(String[] msg) {
                ...
                try{
                    ResponseListPOJO<ChiefComplaintPOJO> responseListPOJO = new Gson().fromJson(msg[1], new TypeToken<ResponseListPOJO<ChiefComplaintPOJO>>() {}.getType());
    ...
    public void updateComplaint(ChiefComplaintPOJO chiefComplaintPOJO){
        Intent intent=new Intent(this, AddChiefComplaintActivity.class);
        intent.putExtra("pojo",chiefComplaintPOJO);
        intent.putExtra("patientPOJO",patientPOJO);
        startActivity(intent);
    }


    ChiefComplaintAdapter adapter;
    List<ChiefComplaintPOJO> chiefComplaintPOJOS=new ArrayList<>();

    public void attachAdapter() {

        adapter = new ChiefComplaintAdapter(this,null, chiefComplaintPOJOS);
