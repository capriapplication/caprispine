...
import com.caprispine.caprispine.activity.assessment.add.AddNeuroExamActivity;
import com.caprispine.caprispine.adapter.patientassessment.NeuroAdapter;
...
public class NeuroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Neuro Exam");
        ...
        btn_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(NeuroActivity.this,NDTPActivity.class).putExtra("patientPOJO",patientPOJO));
                finish();
            }
        });
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult(new Intent(NeuroActivity.this, AddNeuroExamActivity.class).putExtra("patientPOJO",patientPOJO),Constants.EXAM_START_ACTIVITY_INTENT);
            }
        });
    }
    ...
    public void getAllComplaints() {
        ...
        new WebServiceBase(nameValuePairs, this, new WebServicesCallBack() {
            ...
            public void onGetMsg(String[] msg) {
                ...
                try{
                    ResponseListPOJO<NeuroExamPOJO> responseListPOJO = new Gson().fromJson(msg[1], new TypeToken<ResponseListPOJO<NeuroExamPOJO>>() {}.getType());
                    complaintList.clear();
        ...
        }, "",false).execute(WebServicesUrls.NEURO_CRUD);
    }

    public void updateComplaint(NeuroExamPOJO neuroExamPOJO){
        Intent intent=new Intent(this, AddNeuroExamActivity.class);
        intent.putExtra("neuroPOJO",neuroExamPOJO);
    ...
    NeuroAdapter adapter;
    List<NeuroExamPOJO> complaintList=new ArrayList<>();

    public void attachAdapter() {
        adapter = new NeuroAdapter(this,null, complaintList);
