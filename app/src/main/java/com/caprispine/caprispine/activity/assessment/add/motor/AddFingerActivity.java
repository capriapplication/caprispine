...
import com.caprispine.caprispine.fragment.FingerFragment;
...
public class AddFingerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add Finger Exam");
...
//				addMotorAPi();
    ...
    private void saveData(String file_path) {
        try {
            ...
            }, "CALL_HIP_CRUD_API", true).execute(WebServicesUrls.FINGER_CRUD);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
