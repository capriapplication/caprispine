...
import com.caprispine.caprispine.activity.assessment.add.AddPhysioTheraputicActivity;
...
public class PhysioTheraputicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("PhysioTheraputic Exam");
        ...
        btn_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PhysioTheraputicActivity.this,MedicalActivity.class).putExtra("patientPOJO",patientPOJO));
                finish();
            }
        });
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult(new Intent(PhysioTheraputicActivity.this, AddPhysioTheraputicActivity.class).putExtra("patientPOJO",patientPOJO),Constants.EXAM_START_ACTIVITY_INTENT);
            }
        });
    }
    @Override
    ...
    public void getAllComplaints() {
        ...
        }, "",false).execute(WebServicesUrls.PHYSIOTHERAPUTIC_CRUD);
    }
    ...
    public void attachAdapter() {
        adapter = new DiagnosisAdapter(this,null, painPOJOArrayList,"physio");
