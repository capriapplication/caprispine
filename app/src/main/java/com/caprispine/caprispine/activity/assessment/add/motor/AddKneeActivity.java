...
import com.caprispine.caprispine.fragment.KneeFragment;
import com.caprispine.caprispine.pojo.ResponsePOJO;
import com.caprispine.caprispine.pojo.patientassessment.motor.KneePOJO;
...
public class AddKneeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add Knee Exam");
        ...
        try {
            ...
            new WebUploadService(reqEntity, this, new WebServicesCallBack() {
                ...
                public void onGetMsg(String[] msg) {
                    ...
                    ResponsePOJO<KneePOJO> responseListPOJO = new Gson().fromJson(msg[1], new TypeToken<ResponsePOJO<KneePOJO>>() {
                    }.getType());
            ...
            }, "CALL_KNEE_CRUD_API", false).execute(WebServicesUrls.KNEE_CRUD);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
