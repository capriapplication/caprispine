...
import com.caprispine.caprispine.fragment.ShoulderFragment;
...
public class AddShoulderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add Shoulder Exam");
...
//				addMotorAPi();
    ...
    private void saveData(String file_path) {
        try {
            ...
            reqEntity.addPart("left_tone5", new StringBody(UtilityFunction.getToneSpinnerData(getApplicationContext(), frag_left.getSpinner5().getSelectedItemPosition())));
            reqEntity.addPart("left_tone6", new StringBody(UtilityFunction.getToneSpinnerData(getApplicationContext(), frag_left.getSpinner6().getSelectedItemPosition())));
            reqEntity.addPart("left_tone7", new StringBody(UtilityFunction.getToneSpinnerData(getApplicationContext(), frag_left.getSpinner7().getSelectedItemPosition())));
            ...
            reqEntity.addPart("left_power5", new StringBody(UtilityFunction.getPowerSpinnerData(getApplicationContext(), frag_left.getSpinner12().getSelectedItemPosition())));
            reqEntity.addPart("left_power6", new StringBody(UtilityFunction.getPowerSpinnerData(getApplicationContext(), frag_left.getSpinner13().getSelectedItemPosition())));
            reqEntity.addPart("left_power7", new StringBody(UtilityFunction.getPowerSpinnerData(getApplicationContext(), frag_left.getSpinner14().getSelectedItemPosition())));
            ...
            reqEntity.addPart("left_rom5", new StringBody(UtilityFunction.getEdittextData(frag_left.getEdtxt_5())));
            reqEntity.addPart("left_rom6", new StringBody(UtilityFunction.getEdittextData(frag_left.getEdtxt_6())));
            reqEntity.addPart("left_rom7", new StringBody(UtilityFunction.getEdittextData(frag_left.getEdtxt_7())));
            ...
            reqEntity.addPart("right_tone5", new StringBody(UtilityFunction.getToneSpinnerData(getApplicationContext(), frag_right.getSpinner5().getSelectedItemPosition())));
            reqEntity.addPart("right_tone6", new StringBody(UtilityFunction.getToneSpinnerData(getApplicationContext(), frag_right.getSpinner6().getSelectedItemPosition())));
            ...
            reqEntity.addPart("right_power4", new StringBody(UtilityFunction.getPowerSpinnerData(getApplicationContext(), frag_right.getSpinner11().getSelectedItemPosition())));
            reqEntity.addPart("right_power5", new StringBody(UtilityFunction.getPowerSpinnerData(getApplicationContext(), frag_right.getSpinner12().getSelectedItemPosition())));
            reqEntity.addPart("right_power6", new StringBody(UtilityFunction.getPowerSpinnerData(getApplicationContext(), frag_right.getSpinner13().getSelectedItemPosition())));
            reqEntity.addPart("right_power7", new StringBody(UtilityFunction.getPowerSpinnerData(getApplicationContext(), frag_right.getSpinner14().getSelectedItemPosition())));
            ...
            reqEntity.addPart("right_rom5", new StringBody(UtilityFunction.getEdittextData(frag_right.getEdtxt_5())));
            reqEntity.addPart("right_rom6", new StringBody(UtilityFunction.getEdittextData(frag_right.getEdtxt_6())));
            reqEntity.addPart("right_rom7", new StringBody(UtilityFunction.getEdittextData(frag_right.getEdtxt_7())));
            ...
            }, "CALL_HIP_CRUD_API", true).execute(WebServicesUrls.SHOULDER_CRUD);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
