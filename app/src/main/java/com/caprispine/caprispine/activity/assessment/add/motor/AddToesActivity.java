...
import com.caprispine.caprispine.fragment.ToesFragment;
import com.caprispine.caprispine.pojo.ResponsePOJO;
import com.caprispine.caprispine.pojo.patientassessment.motor.ToesPOJO;
...
public class AddToesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add Toes Exam");
        ...
        try {
            ...
            new WebUploadService(reqEntity, this, new WebServicesCallBack() {
                ...
                public void onGetMsg(String[] msg) {
                    ...
                    ResponsePOJO<ToesPOJO> responseListPOJO = new Gson().fromJson(msg[1], new TypeToken<ResponsePOJO<ToesPOJO>>() {
                    }.getType());
            ...
            }, "CALL_HIP_CRUD_API", true).execute(WebServicesUrls.TOES_CRUD);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
