...
import com.caprispine.caprispine.fragment.HipFragment;
...
public class AddHipActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add Hip Exam");
...
//				addMotorAPi();
    ...
    private void saveData(String file_path) {
        try {
            ...
            }, "CALL_HIP_CRUD_API", true).execute(WebServicesUrls.HIP_CRUD);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
