...
import com.caprispine.caprispine.fragment.WristFragment;
...
public class AddWristActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add Wrist Exam");
...
//				addMotorAPi();
    ...
    private void saveData(String file_path) {
        try {
            ...
            }, "CALL_HIP_CRUD_API", true).execute(WebServicesUrls.WRIST_CRUD);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
