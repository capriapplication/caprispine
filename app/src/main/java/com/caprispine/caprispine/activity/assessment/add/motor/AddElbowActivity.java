...
public class AddElbowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add Elbow Exam");
...
//				addMotorAPi();
    ...
    private void saveData(String file_path) {
        try {
            ...
            }, "CALL_HIP_CRUD_API", true).execute(WebServicesUrls.ELBOW_CRUD);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
