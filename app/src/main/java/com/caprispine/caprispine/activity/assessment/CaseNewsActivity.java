...
import com.caprispine.caprispine.activity.assessment.add.AddCaseNoteActivity;
...
public class CaseNewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Case Notes");
        ...
        btn_skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CaseNewsActivity.this,ProgressNotesActivity.class).putExtra("patientPOJO",patientPOJO));
                finish();
            }
        });
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivityForResult(new Intent(CaseNewsActivity.this, AddCaseNoteActivity.class).putExtra("patientPOJO",patientPOJO),Constants.EXAM_START_ACTIVITY_INTENT);
            }
        });
    }
    @Override
    ...
    public void getAllComplaints() {
        ...
        }, "",false).execute(WebServicesUrls.CASE_NOTE_CRUD);
    }
    ...
    public void attachAdapter() {
        adapter = new DiagnosisAdapter(this,null, painPOJOArrayList,"case");
