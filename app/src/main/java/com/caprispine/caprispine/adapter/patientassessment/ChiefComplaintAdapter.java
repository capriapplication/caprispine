...
public class ChiefComplaintAdapter extends RecyclerView.Adapter<ChiefComplaintAdapter.MyViewHolder> {

    private List<ChiefComplaintPOJO> horizontalList;
    ...
    public ChiefComplaintAdapter(Activity activity, Fragment fragment, List<ChiefComplaintPOJO> horizontalList) {
    ...
    public void deleteComplaint(ChiefComplaintPOJO complaintPOJO, final int position){
        ArrayList<NameValuePair> nameValuePairs=new ArrayList<>();
        nameValuePairs.add(new BasicNameValuePair("request_action","delete_complaint"));
        nameValuePairs.add(new BasicNameValuePair("id",complaintPOJO.getId()));
