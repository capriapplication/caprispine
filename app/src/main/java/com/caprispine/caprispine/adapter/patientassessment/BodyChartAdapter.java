...
import com.caprispine.caprispine.activity.assessment.BodyChartViewActivity;
...
public class BodyChartAdapter extends RecyclerView.Adapter<BodyChartAdapter.MyViewHolder> {

    private List<BodyChartPOJO> horizontalList;
    ...
    public BodyChartAdapter(Activity activity, Fragment fragment, List<BodyChartPOJO> horizontalList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.ll_complaint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                if(activity instanceof SensoryActivity){
//                    SensoryActivity sensoryActivity= (SensoryActivity) activity;
//                    sensoryActivity.updateComplaint(horizontalList.get(position));
//                }
                Intent intent=new Intent(activity, BodyChartViewActivity.class);
                intent.putExtra("bodyChartResultPOJO",horizontalList.get(position));
                activity.startActivity(intent);
            }
        });
    }

    public void deleteComplaint(BodyChartPOJO historyPOJO, final int position){
        ArrayList<NameValuePair> nameValuePairs=new ArrayList<>();
        nameValuePairs.add(new BasicNameValuePair("request_action","delete_chart"));
