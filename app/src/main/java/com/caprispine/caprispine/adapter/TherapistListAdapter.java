...
public class TherapistListAdapter extends RecyclerView.Adapter<TherapistListAdapter.MyViewHolder> {
    ...
    public TherapistListAdapter(Activity activity, Fragment fragment, List<TherapistPOJO> horizontalList) {
    ...
    @Override
    public TherapistListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.inflate_patient_list_item, parent, false);

        return new TherapistListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final TherapistListAdapter.MyViewHolder holder, final int position) {
