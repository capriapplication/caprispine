...
public class IncomeTherapistWiseAdapter extends RecyclerView.Adapter<IncomeTherapistWiseAdapter.MyViewHolder> {
    ...
    public IncomeTherapistWiseAdapter(Activity activity, List<IncomePOJO> horizontalList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.tv_vendor.setText(horizontalList.get(position).getPatient_first_name()+" "+horizontalList.get(position).getPatient_last_name());
