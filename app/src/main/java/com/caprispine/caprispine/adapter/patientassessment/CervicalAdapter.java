...
public class CervicalAdapter extends RecyclerView.Adapter<CervicalAdapter.MyViewHolder> {

    private List<CervicalPOJO> horizontalList;
    ...
    public CervicalAdapter(Activity activity, Fragment fragment, List<CervicalPOJO> horizontalList,String delete_url) {
