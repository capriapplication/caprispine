...
public class HipAdapter extends RecyclerView.Adapter<HipAdapter.MyViewHolder> {
    ...
    public HipAdapter(Activity activity, Fragment fragment, List<HistoryPOJO> horizontalList) {
