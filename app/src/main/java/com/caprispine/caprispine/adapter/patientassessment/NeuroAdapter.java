...
public class NeuroAdapter extends RecyclerView.Adapter<NeuroAdapter.MyViewHolder> {

    private List<NeuroExamPOJO> horizontalList;
    ...
    public NeuroAdapter(Activity activity, Fragment fragment, List<NeuroExamPOJO> horizontalList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.ll_complaint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(activity instanceof NeuroActivity){
                    NeuroActivity neuroActivity= (NeuroActivity) activity;
                    neuroActivity.updateComplaint(horizontalList.get(position));
                }
            }
        });
    }

    public void deleteComplaint(NeuroExamPOJO historyPOJO, final int position){
