...
public class SensoryAdapter extends RecyclerView.Adapter<SensoryAdapter.MyViewHolder> {

    private List<SensoryPOJO> horizontalList;
    ...
    public SensoryAdapter(Activity activity, Fragment fragment, List<SensoryPOJO> horizontalList) {
    ...
    public void deleteComplaint(SensoryPOJO historyPOJO, final int position){
