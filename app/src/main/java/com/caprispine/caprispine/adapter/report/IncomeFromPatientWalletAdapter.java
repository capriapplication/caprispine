...
public class IncomeFromPatientWalletAdapter extends RecyclerView.Adapter<IncomeFromPatientWalletAdapter.MyViewHolder> {
    ...
    public IncomeFromPatientWalletAdapter(Activity activity, List<IncomePOJO> horizontalList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.inflat_income_from_patient_wallet, parent, false);
