...
public class NDTAdapter extends RecyclerView.Adapter<NDTAdapter.MyViewHolder> {

    private List<NdtPOJO> horizontalList;
    ...
    public NDTAdapter(Activity activity, Fragment fragment, List<NdtPOJO> horizontalList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.ll_complaint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(activity instanceof NDTPActivity){
                    NDTPActivity ndtpActivity= (NDTPActivity) activity;
                    ndtpActivity.updateComplaint(horizontalList.get(position));
                }
            }
        });
    }

    public void deleteComplaint(NdtPOJO historyPOJO, final int position){
