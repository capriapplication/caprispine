...
public class SpecialTestAdapter extends RecyclerView.Adapter<SpecialTestAdapter.MyViewHolder> {
    ...
    private List<SpecialExamPOJO> horizontalList;
    ...
    public SpecialTestAdapter(Activity activity, Fragment fragment, List<SpecialExamPOJO> horizontalList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.ll_complaint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SpecialExamActivity complaintActivity= (SpecialExamActivity) activity;
                complaintActivity.updateComplaint(horizontalList.get(position));
            }
        });
    }

    public void deleteComplaint(SpecialExamPOJO historyPOJO, final int position){
