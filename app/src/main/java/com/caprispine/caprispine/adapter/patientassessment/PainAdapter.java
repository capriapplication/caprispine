...
public class PainAdapter extends RecyclerView.Adapter<PainAdapter.MyViewHolder> {

    private List<PainPOJO> horizontalList;
    ...
    public PainAdapter(Activity activity, Fragment fragment, List<PainPOJO> horizontalList) {
    ...
    public void deleteComplaint(PainPOJO historyPOJO, final int position){
