...
public class AdminListAdapter extends RecyclerView.Adapter<AdminListAdapter.MyViewHolder> {
    ...
    private List<AdminUserPOJO> horizontalList;
    ...
    public AdminListAdapter(Activity activity, Fragment fragment, List<AdminUserPOJO> horizontalList) {
    ...
    public AdminListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AdminListAdapter.MyViewHolder(itemView);
    }
